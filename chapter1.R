...
p2<- p2 + labs(title = "Modern Englishman head breadth,tackdir=center")
p2<- p2 + xlab( "head breadth (mm) ")
p3<- ggplot(hb_df , aes(x = hb))
p3<- p3 + geom_dotplot(binwidth = 2,stackdir = "centerwhole")
p3<- p3 + labs(title = "Modern Englishman head breadth,tackdir=centerwhole")
...
install.packages("gridExtra")
install.packages("gridExtra")
install.packages("C:/Users/k/AppData/Local/Temp/RtmpgJoJPn/downloaded_packages/gridExtra_2.3.zip", repos = NULL, type = "win.binary")
library(gridExtra)
...
hist(hb,breaks=8,freq=LALSE,main="Histogram,density")
...
rug(hb)
library(vioplot)
install.packages("vioplot", dependencies = FALSE)
install.packages("C:/Users/k/AppData/Local/Temp/RtmpgJoJPn/downloaded_packages/vioplot_0.3.6.zip", repos = NULL, type = "win.binary")
install.packages("C:/Users/k/AppData/Local/Temp/RtmpgJoJPn/downloaded_packages/vioplot_0.3.6.zip", repos = NULL, type = "win.binary")
...
install.packages("sm", dependencies = FALSE)
install.packages("C:/Users/k/AppData/Local/Temp/RtmpSqozLt/downloaded_packages/sm_2.2-5.6.zip", repos = NULL, type = "win.binary")
install.packages("C:/Users/k/AppData/Local/Temp/RtmpSqozLt/downloaded_packages/zoo_1.8-9.zip", repos = NULL, type = "win.binary")
install.packages("zoo")
install.packages("C:/Users/k/AppData/Local/Temp/RtmpSqozLt/downloaded_packages/zoo_1.8-9.zip", repos = NULL, type = "win.binary")
library(vioplot)
library(zoo)
